...
source("TimeTests/NGramTree/Měření 4/RClasses.R")
...
write.csv(results, "TimeTests/NGramTree/Měření 4/Results.csv")
write.csv(means, "TimeTests/NGramTree/Měření 4/Means.csv")