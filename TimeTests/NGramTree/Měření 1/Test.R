...
source("TimeTests/NGramTree/Měření 1/RClasses.R")
...
write.csv(results, "TimeTests/NGramTree/Měření 1/Results.csv")
write.csv(means, "TimeTests/NGramTree/Měření 1/Means.csv")
