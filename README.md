...
You can try the keyboard on [https://jan-sliva.shinyapps.io/Predictive_keyboard_english_15MB/](https://jan-sliva.shinyapps.io/Predictive_keyboard_english_15MB/) (it takes roughly 1 min for the keyboard to load)
